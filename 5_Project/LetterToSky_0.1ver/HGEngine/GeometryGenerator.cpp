...
void GeometryGenerator::CreateBox(float widthMin, float widthMax, float heightMin, float heightMax, float depthMin, float depthMax, MeshData& meshData)
{
	//
	// Create the vertices.
	//
