...
public:
	...
	{
		Vertex()
			:Position(0.0f, 0.0f, 0.0f), Normal(0.0f, 0.0f, 0.0f), TangentU(0.0f, 0.0f, 0.0f), TexC(0.0f, 0.0f) {}
	...
	void CreateBox(float widthMin, float widthMax, float heightMin, float heightMax, float depthMin, float depthMax, MeshData& meshData);
