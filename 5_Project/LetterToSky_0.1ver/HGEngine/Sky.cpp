...
void Sky::Draw(ID3D11DeviceContext* dc, const D3Camera& camera)
{
	...
	Effects::SkyFX->LightTech->GetDesc(&techDesc);

	for (UINT p = 0; p < techDesc.Passes; ++p)
	{
		ID3DX11EffectPass* pass = Effects::SkyFX->LightTech->GetPassByIndex(p);
