...
Lexer::Lexer(LPSTR p_FileName /*= NULL*/, DWORD p_SizeOfBuffer /*= MAX_SIZE_OF_BUFFER*/)
	:m_File(NULL),
	m_Pointer(0),
	m_NowLoaded(0),
	m_SizeOfBuffer(0),
...
BOOL Lexer::Open(LPSTR p_FileName, DWORD p_SizeOfBuffer /*= MAX_SIZE_OF_BUFFER*/)
{
...
LONG Lexer::GetToken(LPSTR p_TokenString)
{
	return 0;
}
